  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Challenge players worldwide in the ultimate game of strategy on Lottie'
        />
        ...
        <div className='space-y-8'>
          ...
          <div className='text-center space-y-4'>
            ...
            <p className='text-gray-300 text-lg'>
              Challenge opponents in the ultimate Rock-Paper-Scissors arena on Somnia Network!
            </p>
          </div>
          ...
          <div className='text-center text-gray-400 text-sm'>
            <p>Powered by Somnia Network | Play Lottie on the blockchain</p>
          </div>
        </div>
      </div>
    </>
